...
const StepLayout = ({ children }: StepLayoutProps) => {
    return (
        <div className="border border-neutral-700 rounded-xl bg-color-dark-bg">
            <div className="border-b border-b-neutral-700 lg:pb-8 space-y-1.5 p-8 lg:p-10">
                <div className="flex items-center gap-2">
                    <BiBookmarks className="lg:size-12 text-orange-500" />
            ...
            <div className="flex relative gap-14 px-14">
                <StepIndicator />
                <div className="grow my-10">{children}</div>
            </div>
        </div>
    );
};
